    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.clicks.update", [$click->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="click_count" id="click_count" value="{{ old('click_count', $click->click_count) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="source" id="source" value="{{ old('source', $click->source) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="user_agent" id="user_agent" value="{{ old('user_agent', $click->user_agent) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ip_address" id="ip_address" value="{{ old('ip_address', $click->ip_address) }}">
