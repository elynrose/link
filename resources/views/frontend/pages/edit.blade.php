                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.pages.update", [$page->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="page_title" id="page_title" value="{{ old('page_title', $page->page_title) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="keywords" id="keywords" value="{{ old('keywords', $page->keywords) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="description" id="description" value="{{ old('description', $page->description) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="body" id="body">{!! old('body', $page->body) !!}</textarea>
                            @if($errors->has('body'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('body') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="footer" id="footer" value="{{ old('footer', $page->footer) }}">
