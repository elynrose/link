    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.socials.update", [$social->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="page_title" id="page_title" value="{{ old('page_title', $social->page_title) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="keywords" id="keywords" value="{{ old('keywords', $social->keywords) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="description" id="description" value="{{ old('description', $social->description) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="threads" id="threads" value="{{ old('threads', $social->threads) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="youtube" id="youtube" value="{{ old('youtube', $social->youtube) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tiktok" id="tiktok" value="{{ old('tiktok', $social->tiktok) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="footer" id="footer" value="{{ old('footer', $social->footer) }}">
