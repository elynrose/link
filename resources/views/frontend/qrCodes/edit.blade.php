                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.qr-codes.update", [$qrCode->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="color" id="color" value="{{ old('color', $qrCode->color) }}">
                            @if($errors->has('color'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('color') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="size" id="size" value="{{ old('size', $qrCode->size) }}" step="1">
                            @if($errors->has('size'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('size') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="bg_color" id="bg_color" value="{{ old('bg_color', $qrCode->bg_color) }}">
