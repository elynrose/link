        ...
        <form method="POST" action="{{ route("admin.links.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('add_utm') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="add_utm" id="add_utm" value="1" {{ old('add_utm', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Link::TYPE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('type') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="type_{{ $key }}" name="type" value="{{ $key }}" {{ old('type', 'short_url') === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('custom_name') ? 'is-invalid' : '' }}" type="text" name="custom_name" id="custom_name" value="{{ old('custom_name', '') }}">
