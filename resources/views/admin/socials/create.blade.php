    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.socials.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('page_title') ? 'is-invalid' : '' }}" type="text" name="page_title" id="page_title" value="{{ old('page_title', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('threads') ? 'is-invalid' : '' }}" type="text" name="threads" id="threads" value="{{ old('threads', '') }}">
