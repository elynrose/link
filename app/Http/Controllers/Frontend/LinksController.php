...
class LinksController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.links.index', compact('links'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.links.create', compact('domains', 'users'));
    }
    ...
    public function store(StoreLinkRequest $request)
    {
        ...
        return redirect()->route('frontend.links.index');
    }
    ...
    public function edit(Link $link)
    {
        ...
        return view('frontend.links.edit', compact('domains', 'link', 'users'));
    }
    ...
    public function show(Link $link)
    {
        ...
        return view('frontend.links.show', compact('link'));
    }
