...
class HomeController
{
    public function index()
    {
        ...
        $settings2 = [
            'chart_title'           => 'Unique Click Count',
            'chart_type'            => 'line',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Click',
            'group_by_field'        => 'created_at',
        ...
        $settings3 = [
            'chart_title'           => 'Total clicks for this week',
        ...
        $settings4 = [
            'chart_title'           => 'Total clicks this month',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Click',
            'group_by_field'        => 'created_at',
        ...
        $settings5 = [
            'chart_title'           => 'Average clicks this month',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Click',
            'group_by_field'        => 'created_at',
        ...
        $settings6 = [
            'chart_title'        => 'Clicks By Devices',
            'chart_type'         => 'latest_entries',
            'report_type'        => 'group_by_string',
            'model'              => 'App\Models\Click',
            'group_by_field'     => 'user_agent',
            'aggregate_function' => 'sum',
            'aggregate_field'    => 'click_count',
            'filter_field'       => 'created_at',
            'filter_days'        => '30',
        ...
        $settings7 = [
            'chart_title'           => 'Clicks by location',
            'chart_type'            => 'latest_entries',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Click',
            'group_by_field'        => 'created_at',
        ...
        return view('home', compact('chart1', 'chart2', 'settings3', 'settings4', 'settings5', 'settings6', 'settings7'));
    }
}
